...
const createWindow = (): void => {
	...
	const predicatorPath = path.resolve(__dirname, 'predictor');

	const analyze_single_package = async (e: IpcMainInvokeEvent, packagePath: string) => {
		return await analyzeSinglePackage(packagePath, predicatorPath);
	};
	...
	const analyze_directory = async(e: IpcMainInvokeEvent, dirPath: string) => {
		return await analyzeDirectory(dirPath, mainWindow.webContents, predicatorPath);
	};
